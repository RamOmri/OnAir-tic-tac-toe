To initialize the project download the git repository then run npm i from the root folder to install the required dependencies. The app was made on a physical device
